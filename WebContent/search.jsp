...
<div class="index_menu">
	<h3>カテゴリー</h3>
		...
		<dl>
			<dt>値段</dt>
			<dd>
				<input type="text" onkeyup="(this.v = function(){this.value  = this.value.replace(/[*a-z-A-Z-]+/,'');}).call(this)" onblur="this.v();" />
				～
				<input type="text" onkeyup="(this.v = function(){this.value  = this.value.replace(/[*a-z-A-Z-]+/,'');}).call(this)" onblur="this.v();" />
			</dd>
		</dl>
...
<% ArrayList<HashMap<String, String>> list = (ArrayList<HashMap<String, String>>)request.getAttribute("search"); %>
