...
<body>
	...
	<h1 class="body_h1">新しい住所を追加</h1>
	<script src="https://yubinbango.github.io/yubinbango/yubinbango.js" charset="UTF-8"></script>
	<form action="newaddress" method="post" class="h-adr" id="myForm">
		...
		<div class="address_div">
			<ul class="input_address">
				...
				<li><input type="submit" value="住所を追加" class="form_control btn address_btn"></li>
			</ul>
		</div>
	</form>
	<br>
